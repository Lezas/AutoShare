...
use StackExchangeBundle\Model\AnswerCommentManager as BaseCommentManager;
use Symfony\Component\EventDispatcher\EventDispatcherInterface;


class AnswerCommentManager extends BaseCommentManager
{
    /**
     * @var EntityManager
     */
    ...
    public function __construct(EventDispatcherInterface $dispatcher, EntityManager $em)
    {
        ...
        $this->em = $em;
        $this->repository = $em->getRepository(AnswerComment::class);

        $metadata = $em->getClassMetadata(AnswerComment::class);
